...
export function ToastProvider({ children }) {
  ...
  return (
    <ToastContext.Provider value={show}>
      ...
      {/* Тост */}
      <div
        className="fixed bottom-7 left-1/2 z-[200] flex items-center gap-[10px] px-5 py-[13px] rounded-[13px] text-sm font-semibold text-ink pointer-events-none transition-all bg-[rgba(20,20,28,0.92)] backdrop-blur-[18px] border border-primary/40 shadow-toast"
