  ...
  return (
    <section id="security" className="px-6 pt-[70px] pb-20 max-w-[1100px] mx-auto">
      <div ref={headRef} style={revealStyle(headVis)} className="text-center max-w-[640px] mx-auto mb-[46px]">
        <div className="text-[13px] font-bold tracking-[.06em] uppercase text-[#8B88FF]">{tr.bio.eyebrow}</div>
        <h2 className="font-display font-bold mt-[14px] text-[clamp(28px,4vw,42px)] tracking-[-.03em]">{tr.bio.title}</h2>
      ...
      <div className="grid md:grid-cols-2 gap-[18px]">
        ...
        <div
          ref={fpRef}
          style={revealStyle(fpVis)}
          className="relative overflow-hidden rounded-[22px] border border-white/[0.08] p-9 flex flex-col items-center text-center bg-panel"
        >
          <div className="absolute pointer-events-none rounded-full -top-[20%] left-1/2 -ml-[150px] w-[300px] h-[300px] blur-[40px] bg-[radial-gradient(circle,rgba(94,92,230,.25),transparent_65%)]" />
          ...
          <div className="mt-[18px] inline-flex items-center gap-2 px-[15px] py-2 rounded-[10px] text-[13px] font-semibold border bg-success/[0.12] border-success/30 text-success-soft">
        ...
        <div
          ref={faceRef}
          style={revealStyle(faceVis, 100)}
          className="relative overflow-hidden rounded-[22px] border border-white/[0.08] p-9 flex flex-col items-center text-center bg-panel"
        >
          <div className="absolute pointer-events-none rounded-full -top-[20%] left-1/2 -ml-[150px] w-[300px] h-[300px] blur-[40px] bg-[radial-gradient(circle,rgba(167,139,250,.22),transparent_65%)]" />
          <svg width="120" height="120" viewBox="0 0 120 120" fill="none" className="relative">
