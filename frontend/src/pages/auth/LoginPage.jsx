...
export default function LoginPage() {
  ...
  // Демо-вход: помечаем сессию и переходим в рабочую область.
  const handleLogin = () => {
      ...
      <section className="w-full max-w-[440px]">
        ...
        <div className="rounded-3xl border border-white/[.09] p-7" style={{ background: "rgba(20,20,28,.72)", backdropFilter: "blur(22px)", boxShadow: "0 30px 80px rgba(0,0,0,.5)" }}>
          ...
          <div className="flex flex-col gap-3">
            <Field label="Email" type="email" placeholder="you@clinic.kz" value={email} onChange={(e) => setEmail(e.target.value)} />
